...
parser.add_argument('--kitti15_datapath', default='../VFDSNet-main/data/KITTI_2015/', help='data path')
parser.add_argument('--kitti12_datapath', default='../VFDSNet-main/data/KITTI_2012/', help='data path')
parser.add_argument('--datapath', default="../ACVNet-main/data/sceneflow/", help='data path')
...
parser.add_argument('--loadckpt', default='./pretrained_model/kitti2012.ckpt',
...
def test():
    ...
    for batch_idx, sample in enumerate(TestImgLoader):
        ...
        loss, scalar_outputs, EPE, D1, Thres1, Thres2, Thres3 = test_sample(sample)
        avg_test_scalars.update(scalar_outputs)
        del scalar_outputs
        print(
            'Iter {}/{}, test loss = {:.3f}, time = {:3f}, EPE = {:.3f}, D1 = {:.4f}, Thres1 = {:.4f}, Thres2 = {:.4f}, Thres3 = {:.4f}'.format(
                batch_idx,
                len(TestImgLoader), loss,
                time.time() - start_time,
                EPE[0], D1[0], Thres1[0], Thres2[0], Thres3[0]))
...
def test_sample(sample):
    ...
    return tensor2float(loss), tensor2float(scalar_outputs), scalar_outputs["EPE"], scalar_outputs["D1"], \
           scalar_outputs["Thres1"], scalar_outputs["Thres2"], scalar_outputs["Thres3"]
