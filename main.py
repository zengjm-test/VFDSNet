...
parser.add_argument('--logdir', default='./file_ckpt/VFDSNet/', help='the directory to save logs and checkpoints')
    ...
    for epoch_idx in range(start_epoch, args.epochs):
        ...
        if (epoch_idx) % 1 == 0:
            ...
            for batch_idx, sample in enumerate(TestImgLoader):
                ...
                if str(scalar_outputs['loss']) == 'nan':
                    scalar_outputs['loss'] = 0
            ...
            avg_test_scalars_df.to_csv('{}{}.{}.csv'.format(args.logdir, int(epoch_idx + 1), args.epochs))
